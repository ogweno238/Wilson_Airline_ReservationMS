...
<html>
	...
	<img class="logo" src="admin/img/ndege.jpg"/> 
		...
		<?php
			...
			$airline_no=$_POST['select_airline'];
			$_SESSION['airline_no']=$airline_no;
			//$pass_name=array();
			...
			while($count<=$no_of_pass)
			{
					...
					echo "<td class=\"fix_table_short\">Passenger's Meal</td>";
					echo "<td class=\"fix_table_short\">Passenger's ID (if applicable)</td>";
					echo "</tr>";
					echo "<tr>";
				...
				echo "<tr>";
				echo "<td class=\"fix_table_short\">Do you want snacks?</td>";
				echo "<td class=\"fix_table_short\">Do you want Soft drinks?</td>";
