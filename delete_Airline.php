     ...
     <div class="container">
        <div class="row-fluid">
            <div class="span3">
				...
				<li  class="active"><a href="delete_Airline.php"><i class="fa fa-Airline" aria-hidden="true"></i> Delete Airline Schedule</a>
				</li>
		...
		<form action="deactivate_Airline_details.php" method="post">
			
			<div>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>The Airline has been successfully deactivated.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>*Invalid Airline No entered, please enter again.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				...
				<tr>
					<td class="fix_table"><input id="naekana" placeholder="Airline No" type="text" name="tablet_id" required></td>
				</tr>
			</table>
			<br>
