            ...
            <div class="container">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="row-fluid">
                            <div class="span6">
                                <img src="admin/images/logo.png" width="180px" height="150px" >
                            </div>
                            <div class="span6">
                                <div class="pull-right">
                                    <!--- login button -->							
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="#driver" role="button"  data-toggle="modal">&nbsp;User Login</a></li>

  <li><a href="#Signup" role="button"  data-toggle="modal">&nbsp;User Registration</a></li>

                                            <li><a href="#Admin" role="button"  data-toggle="modal">&nbsp;Admin</a></li>
                                  ...
                                  <?php include('customer_modal.php'); ?>
                                    ...
                                    <?php include('passenger_modal.php'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
